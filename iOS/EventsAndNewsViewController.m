...
@interface EventsAndNewsViewController ()

@end

@implementation EventsAndNewsViewController
...
- (void) viewDidLoad{
    ...
    [self addButton:headerButton title:@"Events" contentView:contentView beneath:contentView position:1 width:buttonWidth margin:buttonVMargin];
    ...
    UIButtonWithString *firstButton = [[UIButtonWithString alloc] initWithStringTag:@"https://www.realestategrp.com/blog/"];
    [MyUtilities addButton:firstButton title:@"NEWS FEED" selfView:self.view contentView:contentView beneath:headerButton position:2 width:buttonWidth margin:buttonVMargin];
    [firstButton addTarget:self action:@selector(openURL:) forControlEvents:UIControlEventTouchUpInside];
    
    UIButtonWithString *secondButton = [[UIButtonWithString alloc] initWithStringTag:nil];
    [MyUtilities addButton:secondButton title:@"*CLIENT PARTIES*" selfView:self.view contentView:contentView beneath:firstButton position:2 width:buttonWidth margin:buttonVMargin];
    [secondButton addTarget:self action:@selector(openURL:) forControlEvents:UIControlEventTouchUpInside];
    
    UIButtonWithString *thirdButton = [[UIButtonWithString alloc] initWithStringTag:nil];
    [MyUtilities addButton:thirdButton title:@"*EVENTS THIS MONTH*" selfView:self.view contentView:contentView beneath:secondButton position:3 width:buttonWidth margin:buttonVMargin];
    [thirdButton addTarget:self action:@selector(openURL:) forControlEvents:UIControlEventTouchUpInside];
